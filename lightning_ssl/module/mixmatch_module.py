...
from lightning_ssl.utils.torch_utils import half_mixup_data, soft_cross_entropy, l2_distribution_loss, \
    smooth_label, customized_weight_decay, interleave, sharpening
...
class MixmatchModule(ClassifierModule, Mixmatch):
    ...
    def training_step(self, batch, batch_nb):
        ...
        loss, l_l, l_u = self._loss(labeled_x, labeled_y, unlabeled_xs, batch_inference=self.hparams.batch_inference)
